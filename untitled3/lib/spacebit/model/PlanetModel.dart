...
List<PlanetModel> planetModelFromJson(String str) => List<PlanetModel>.from(json.decode(str).map((x) => PlanetModel.fromJson(x)));

String planetModelToJson(List<PlanetModel> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));
