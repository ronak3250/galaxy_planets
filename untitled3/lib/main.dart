...
import 'package:untitled3/spacebit/controller/themeProvider.dart';
import 'package:untitled3/spacebit/controller/valuechecker.dart';
import 'package:untitled3/spacebit/view/DetailScreen.dart';
import 'package:untitled3/spacebit/view/FavouriteScreen.dart';
import 'package:untitled3/spacebit/view/SplashScreen.dart';
                  ...
                  child: Container(
                    ...
                    child: Align(
                      ...
                      child: CurvedCarousel(
                        onChangeStart: (index, automatic) => vax.valueSet=index,
middleItemScaleRatio: 3,
                        ...
                        itemBuilder: (p0, p1) {
                          return AnimatedBuilder(
                            ...
                            child: InkWell(
                              onTap: () {
                                Navigator.push(context, MaterialPageRoute(builder: (context) => DetailScreen(value: _items[p1]),));
                              },
                              child: Hero(
                                tag: _items[p1]['hero'],
                                child: Container(
                                  ...
                                  decoration: BoxDecoration(
                                      ...
                                      image: DecorationImage(
                                          image: AssetImage(_items[p1]["image"]),
                                          fit: BoxFit.cover)),
